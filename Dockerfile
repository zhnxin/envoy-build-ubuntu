...
RUN cd /root &&\
  ...
  cd "envoy" &&\
  timeout 300s python3 tools/vscode/generate_debug_config.py //test/extensions/filters/network/dubbo_proxy:dubbo_hessian2_serializer_impl_test --debugger "lldb" || true
